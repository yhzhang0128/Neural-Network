...
%(sum(sum(Theta1.*Theta1)(2:size(Theta1, 2))) + sum(sum(Theta2.*Theta2)(2:size(Theta2, 2))))
...
regTheta2 = Theta2;
regTheta2(1:size(Theta2, 1), 1) = 0;
regTheta2 = regTheta2 * lambda / m;
